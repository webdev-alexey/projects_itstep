...
<body>
 ...
 <!--                   <li>
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Категории <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="categories.php">Все категории</a>
                            </li>
                            <li>
                                <a href="#">Добавить категории</a>
                            </li>
                        </ul>
                    </li>
                                        <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-fw fa-file"></i> Коментарии</a>
                    </li>
                    <li>
